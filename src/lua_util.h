...
#define RETRIEVE_LUA_FIELD_A(N) N & 0xFC03FFFF
#define RETRIEVE_LUA_FIELD_B(N) N & 0xFFFC01FF
#define RETRIEVE_LUA_FIELD_BX(N) N && 0xFFFC0000
#define RETRIEVE_LUA_FIELD_SBX(N) (signed) RETRIEVE_LUA_FIELD_BX(N)
#define RETRIEVE_LUA_FIELD_C(N) N & 0xFC01FFFF
